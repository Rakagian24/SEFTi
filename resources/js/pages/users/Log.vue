...
function getActionDescription(action: string) {
  switch (action.toLowerCase()) {
    case "created":
    case "create":
      return "Membuat data User";
    case "updated":
    case "update":
      return "Mengubah data User";
    case "deleted":
    case "delete":
      return "Menghapus data User";
    case "out":
      return "Mengeluarkan data User";
    case "received":
      return "Menerima data User";
    case "returned":
  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="pl-2 pt-6 pr-6 pb-6">
      <LogScaffold
        ...
        headerTitle="User Activity Details"
        infoTitle="User Activities"
        :infoSubtitle="`Riwayat aktivitas untuk User ${ user?.name || '' }`"
        :icon="User"
      >
            ...
            <div class="flex items-center">
              <div class="text-left">
                <h3 class="text-lg font-semibold text-gray-900 capitalize mb-1">
                  {{ getActionDescription(log.action) }} {{ user?.name }}
                </h3>
