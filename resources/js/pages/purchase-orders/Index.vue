    ...
    <div class="pl-2 pt-6 pr-6 pb-6">
      ...
      <div v-if="showFailedMessage" class="mb-6">
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 shadow-lg">
          ...
          <div class="absolute top-0 left-0 h-1 bg-amber-300 rounded-t-lg transition-all duration-1000" :style="{ width: progressWidth + '%' }"></div>
          ...
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1">
              ...
              <!-- Failed PO Details -->
              <div class="space-y-3">
                <div v-for="po in failedPOs" :key="po.id" class="bg-white rounded-lg p-4 border border-amber-200 shadow-sm hover:shadow-md transition-shadow">
                  <div class="flex items-start justify-between">
                    <div class="flex-1">
                      ...
                      <div class="text-amber-800 text-sm space-y-1.5 ml-4">
                        <div v-for="(error, index) in po.errors" :key="index" class="flex items-start">
                          <span class="w-1.5 h-1.5 bg-amber-400 rounded-full mr-2 mt-1.5 flex-shrink-0"></span>
                          <span>{{ error }}</span>
                        </div>
                      </div>
                    </div>
...
watch(() => page.props, (newProps: any) => {
  ...
  if (newProps.failed_pos && Array.isArray(newProps.failed_pos) && newProps.failed_pos.length > 0) {
...
onMounted(() => {
  ...
  if (pageProps.failed_pos && Array.isArray(pageProps.failed_pos) && pageProps.failed_pos.length > 0) {
