...
function getActionDescription(action: string) {
  switch (action.toLowerCase()) {
    case "created":
    case "create":
      return "Membuat data Bank Account";
    case "updated":
    case "update":
      return "Mengubah data Bank Account";
    case "deleted":
    case "delete":
      return "Menghapus data Bank Account";
    case "out":
      return "Mengeluarkan data Bank Account";
    case "received":
      return "Menerima data Bank Account";
    case "returned":
      return "Mengembalikan data Bank Account";
    default:
      return action;
  }
}
...
function applyFilters() {
  ...
  router.get(`/bank-accounts/${props.bankAccount?.id}/logs`, params, {
    preserveState: true,
    preserveScroll: true,
  });
}
  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="px-4 pt-4 pb-6">
      <LogScaffold
        ...
        headerTitle="Bank Account Activity Details"
        infoTitle="Bank Account Activities"
        :infoSubtitle="`Riwayat aktivitas untuk Bank Account ${ bankAccount?.nomor_rekening || (bankAccount as any)?.no_rekening || '' }`"
        :icon="User"
      >
        ...
        <div class="space-y-0">
          ...
          >
            ...
            <p class="text-gray-500">
              There are no activities recorded for this bank account.
            </p>
          </div>
        </div>
