          ...
          >
            ...
            <div class="mb-4">
              ...
              <div class="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  :class="{
                    'bg-green-500': memoPembayaran.purchase_order.termin.status_termin === 'completed',
                    'bg-blue-500': memoPembayaran.purchase_order.termin.status_termin === 'in_progress',
                    'bg-gray-400': memoPembayaran.purchase_order.termin.status_termin === 'not_started'
                  }"
                  :style="{
                    width:
                      ((memoPembayaran.purchase_order.termin.jumlah_termin_dibuat || 0) /
                        (memoPembayaran.purchase_order.termin.jumlah_termin || 1)) * 100 + '%'
                  }"
                ></div>
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div class="bg-white p-3 rounded-lg border border-gray-200">
                ...
                <div class="text-xl font-bold text-gray-900">{{ formatCurrency(memoPembayaran.purchase_order.termin.grand_total || 0) }}</div>
              </div>
              <div class="bg-white p-3 rounded-lg border border-gray-200">
                <div class="text-sm text-gray-600 mb-1">Total Cicilan</div>
                <div class="text-xl font-bold text-blue-600">{{ formatCurrency(memoPembayaran.purchase_order.termin.total_cicilan || 0) }}</div>
              </div>
              <div class="bg-white p-3 rounded-lg border border-gray-200">
                <div class="text-sm text-gray-600 mb-1">Sisa Pembayaran</div>
                <div class="text-xl font-bold text-orange-600">{{ formatCurrency(memoPembayaran.purchase_order.termin.sisa_pembayaran || 0) }}</div>
              </div>
            </div>
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
              <div class="flex items-center">
                <div
                  ...
                  :class="{
                    'bg-green-500': memoPembayaran.purchase_order.termin.status_termin === 'completed',
                    'bg-yellow-500': memoPembayaran.purchase_order.termin.status_termin === 'in_progress',
                    'bg-gray-400': memoPembayaran.purchase_order.termin.status_termin === 'not_started'
                  }"
                ></div>
                <span
                  :class="{
                    'text-green-600 font-semibold': memoPembayaran.purchase_order.termin.status_termin === 'completed',
                    'text-yellow-600 font-semibold': memoPembayaran.purchase_order.termin.status_termin === 'in_progress',
                    'text-gray-600 font-semibold': memoPembayaran.purchase_order.termin.status_termin === 'not_started'
                  }"
                >
                  {{
                    memoPembayaran.purchase_order.termin.status_termin === 'completed'
                      ? 'Termin Selesai'
                      : memoPembayaran.purchase_order.termin.status_termin === 'in_progress'
