    ...
    <div class="px-4 md:px-6 pt-4 md:pt-6 pb-6">
        ...
        <div class="space-y-0">
          ...
          >
            ...
            <p class="text-gray-500">
              There are no activities recorded for this PO Anggaran.
            </p>
          </div>
        </div>
      ...
      <div class="mt-6">
        ...
        >
          ...
          Kembali ke Approval PO Anggaran
        </button>
      </div>
      </LogScaffold>
    </div>
...
const poAnggaranId = (props.poAnggaran as any)?.id;
...
const breadcrumbs = [
  ...
  { label: "PO Anggaran", href: "/approval/po-anggaran" },
  { label: "Log Aktivitas" },
];
...
function goBack() {
  if (window.history.length > 1) {
    ...
    router.visit("/approval/po-anggaran");
  }
}
...
function handlePagination(url: string | null) {
  ...
  router.get(`/approval/po-anggaran/${poAnggaranId}/log`, params, {
    preserveState: true,
    preserveScroll: true,
  });
}
