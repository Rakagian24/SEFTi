...
function getActionDescription(action: string) {
  switch (action.toLowerCase()) {
    case "created":
    case "create":
      return "Membuat data Bisnis Partner";
    case "updated":
    case "update":
      return "Mengubah data Bisnis Partner";
    case "deleted":
    case "delete":
      return "Menghapus data Bisnis Partner";
    case "out":
      return "Mengeluarkan data Bisnis Partner";
    case "received":
      return "Menerima data Bisnis Partner";
    case "returned":
      return "Mengembalikan data Bisnis Partner";
    default:
      return action;
  }
}
        ...
        <div class="space-y-0">
            ...
            <div class="flex items-center">
              <div class="text-left">
                <h3 class="text-lg font-semibold text-gray-900 capitalize mb-1">
                  {{ getActionDescription(log.action) }} {{ bisnisPartner?.nama_bisnis_partner }}
                </h3>
          ...
          >
            ...
            <p class="text-gray-500">
              There are no activities recorded for this bisnis partner.
            </p>
          </div>
        </div>
