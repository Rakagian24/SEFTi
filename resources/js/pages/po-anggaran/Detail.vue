  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="pl-2 pt-6 pr-6 pb-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="(item, index) in poAnggaran?.items || []" :key="index" class="hover:bg-gray-50 transition-colors">
                      ...
                      <td class="px-6 py-4 text-center"><span class="text-sm text-gray-900">{{ item.qty || 1 }}</span></td>
            ...
            <div class="space-y-6">
              <div>
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                  <p class="text-sm text-gray-900 leading-relaxed">{{ poAnggaran?.detail_keperluan || '-' }}</p>
                </div>
              </div>
        ...
        <!-- Right Column - Summary & Metadata (reserved) -->
        <div class="space-y-6">
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div class="flex items-center gap-2 mb-4">
              <svg class="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const props = defineProps<{ poAnggaran: any }>();
