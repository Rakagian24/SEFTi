  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="pl-2 pt-6 pr-6 pb-6">
      <LogScaffold
        ...
        headerTitle="Supplier Activity Details"
        infoTitle="Supplier Activities"
        :infoSubtitle="`Riwayat aktivitas untuk Supplier ${ supplier?.nama_supplier || '' }`"
        :icon="User"
      >
        ...
        <div class="space-y-0">
          ...
          >
            ...
            <p class="text-gray-500">
              There are no activities recorded for this supplier.
            </p>
          </div>
        </div>
