...
function handleClickOutside(event: MouseEvent) {
  ...
  if (
    departmentDropdownRef.value &&
    departmentDropdownRef.value.contains(event.target as Node)
  )
    return;
...
const selectedDepartmentNames = computed(() => {
  ...
  if (selectedDepartments.value.length === 1) {
    const dept = props.departments.find(
      (d) => d.id.toString() === selectedDepartments.value[0]
    );
...
<template>
  ...
  <div class="min-h-screen w-full bg-[#333333]">
    <div class="flex h-screen w-full relative">
      <!-- Login Panel -->
      <div
        class="w-1/2 flex items-center justify-center p-8 bg-[#DFECF2] relative transition-all duration-700 ease-in-out"
        ...
        <div class="w-full max-w-md">
          <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">
              Sign In to
              <span
                class="font-normal font-pacifico bg-gradient-to-b from-[#22C1C3] to-[#41499F] text-transparent bg-clip-text"
                >SEFTi.</span
              >
            </h2>
          </div>
          ...
          <form @submit.prevent="submitLogin" class="space-y-6">
            <div class="space-y-2">
              <div class="relative mt-6">
                ...
                <label
                  for="login-email"
                  class="absolute left-10 duration-200 transform pointer-events-none peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-400 peer-focus:top-0 peer-focus:-translate-y-0 peer-focus:text-xs peer-focus:text-gray-700 top-0 -translate-y-0 text-xs text-gray-700"
                >
                  Email<span class="text-red-500">*</span>
                </label>
              </div>
              <div v-if="loginForm.errors.email" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              ...
              <div v-if="loginForm.errors.password" class="text-red-500 text-xs">
            ...
            <Button
              type="submit"
              class="w-full h-14 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-full"
        ...
        <div class="w-full max-w-md">
          ...
          <form @submit.prevent="submitRegister" class="space-y-4">
            ...
            <div class="space-y-2">
              ...
              <div v-if="registerForm.errors.name" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              ...
              <div v-if="registerForm.errors.email" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              ...
              <div v-if="registerForm.errors.password" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              ...
              <div v-if="registerForm.errors.phone" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              <div class="relative mt-6" ref="roleDropdownRef">
                ...
                >
                  <span
                    :class="[registerForm.role_id ? 'text-gray-700' : 'text-gray-400']"
                  >
                    {{
                      props.roles.find((r) => r.id.toString() === registerForm.role_id)
                        ?.name || ""
                    }}
                  </span>
                  <svg
                ...
                <div
                  ...
                  class="absolute top-full left-0 w-full bg-white rounded-xl shadow-lg border border-gray-200 max-h-56 overflow-y-auto z-[9999] mt-1"
                >
                  <div
            ...
            <div class="space-y-2">
              <div class="relative mt-6" ref="departmentDropdownRef">
                ...
                >
                  <span
                    :class="[
                      selectedDepartments.length > 0 ? 'text-gray-700' : 'text-gray-400',
                    ]"
                  >
                ...
                <div
                  v-if="registerForm.errors.department_ids"
            ...
            <Button
              type="submit"
              class="w-full h-14 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-full mt-6"
      ...
      <div
        class="absolute top-0 w-1/2 h-full bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white transition-all duration-800 ease-in-out"
      ...
      >
        ...
        <div class="absolute inset-0 opacity-15">
          ...
          <div class="absolute top-8 left-8">
            ...
            <div
              class="absolute top-2 left-2 w-20 h-20 border-2 border-white rounded-full opacity-40"
            ></div>
            <div
              class="absolute top-4 left-4 w-16 h-16 border-2 border-white rounded-full opacity-30"
            ></div>
            <div
              class="absolute top-6 left-6 w-12 h-12 border-2 border-white rounded-full opacity-20"
            ></div>
          </div>
          ...
          <div class="absolute top-16 right-16">
            <div
              class="w-0 h-0 border-l-8 border-r-8 border-b-12 border-l-transparent border-r-transparent border-b-white transform rotate-45"
            ></div>
            <div
              class="absolute top-4 left-4 w-0 h-0 border-l-6 border-r-6 border-b-8 border-l-transparent border-r-transparent border-b-white transform -rotate-12"
            ></div>
            <div
              class="absolute -top-2 -right-2 w-0 h-0 border-l-4 border-r-4 border-b-6 border-l-transparent border-r-transparent border-b-white transform rotate-90"
            ></div>
          </div>
          ...
          <div class="absolute top-1/3 left-12">
            <div
              class="w-16 h-24 border-2 border-white transform rotate-12 opacity-50"
            ></div>
            <div
              class="absolute top-2 left-2 w-12 h-20 border-2 border-white transform -rotate-6 opacity-40"
            ></div>
          </div>
          ...
          <div class="absolute top-1/2 right-20">
            <div
              class="w-0 h-0 border-l-6 border-r-6 border-b-10 border-l-transparent border-r-transparent border-b-white opacity-60"
            ></div>
            <div
              class="absolute top-3 -left-2 w-0 h-0 border-l-4 border-r-4 border-b-6 border-l-transparent border-r-transparent border-b-white opacity-50"
            ></div>
            <div
              class="absolute top-3 left-2 w-0 h-0 border-l-4 border-r-4 border-b-6 border-l-transparent border-r-transparent border-b-white opacity-50"
            ></div>
            <div
              class="absolute top-6 left-0 w-0 h-0 border-l-3 border-r-3 border-b-4 border-l-transparent border-r-transparent border-b-white opacity-40"
            ></div>
          </div>
          ...
          <div class="absolute bottom-24 left-20">
            ...
            <div
              class="absolute -top-2 -right-2 w-4 h-4 bg-white rounded-full opacity-40"
            ></div>
            <div
              class="absolute top-6 left-6 w-3 h-3 bg-white rounded-full opacity-50"
            ></div>
          </div>
          ...
          <div class="absolute bottom-16 right-12">
            ...
            <div
              class="absolute top-2 left-2 w-16 h-16 border border-white rounded-full opacity-30"
            ></div>
            <div
              class="absolute top-6 left-6 w-8 h-8 bg-white rounded-full opacity-60"
            ></div>
          </div>

          <!-- Scattered small elements -->
          <div
            class="absolute top-1/4 left-1/3 w-2 h-2 bg-white rounded-full opacity-50"
          ></div>
          <div
            class="absolute top-2/3 left-1/4 w-1.5 h-1.5 bg-white rounded-full opacity-60"
          ></div>
          <div
            class="absolute top-1/2 left-2/3 w-1 h-1 bg-white rounded-full opacity-70"
          ></div>
          <div
            class="absolute top-3/4 right-1/3 w-2.5 h-2.5 bg-white rounded-full opacity-40"
          ></div>

          <!-- Diagonal lines -->
          <div
            class="absolute top-1/4 left-1/4 w-32 h-0.5 bg-white transform rotate-45 opacity-30"
          ></div>
          <div
            class="absolute bottom-1/3 right-1/4 w-24 h-0.5 bg-white transform -rotate-45 opacity-30"
          ></div>
          <div
            class="absolute top-1/3 right-1/2 w-20 h-0.5 bg-white transform rotate-12 opacity-25"
          ></div>
          <div
            class="absolute bottom-1/4 left-1/3 w-28 h-0.5 bg-white transform -rotate-12 opacity-25"
          ></div>

          <!-- Additional geometric elements -->
          <div
            class="absolute top-2/3 left-1/2 w-6 h-6 border-2 border-white transform rotate-45 opacity-40"
          ></div>
          <div
            class="absolute top-1/6 right-1/2 w-4 h-8 border border-white transform rotate-30 opacity-35"
          ></div>
        ...
        <div class="flex items-center justify-center h-full">
          <div class="text-center z-10 p-8">
            ...
            <p v-if="isLogin" class="text-lg text-gray-300 mb-8 max-w-md mx-auto">
              ...
              <span
                class="bg-gradient-to-b from-[#22C1C3] to-[#41499F] text-transparent bg-clip-text"
                >SEFTi.</span
              >
            </p>
            <p
              v-else
              class="text-lg text-gray-300 mb-8 max-w-md mx-auto h-7 overflow-hidden flex items-center justify-center relative"
            >
              <Transition name="slide-up" mode="out-in">
                <span v-if="showTagline" :key="taglineIndex">{{
                  registerTaglines[taglineIndex]
                }}</span>
              </Transition>
            </p>
            <Button
