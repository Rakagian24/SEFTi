...
<template>
  ...
  <div class="min-h-screen w-full bg-[#333333]">
    ...
    <div class="md:hidden min-h-screen flex flex-col">
      <!-- Mobile Header -->
      <div class="bg-gradient-to-br from-gray-800 via-gray-900 to-black text-white p-6 pb-8">
        <div class="text-2xl font-normal mb-8">
      ...
      <div class="flex-1 bg-[#DFECF2] p-6 overflow-y-auto">
        <!-- Login Form Mobile -->
            ...
            <div class="space-y-2">
              <div class="relative mt-6">
                ...
                <Input
                  ...
                  class="pl-10 h-12 bg-transparent border-0 border-b-2 border-gray-700 focus:border-cyan-500 focus:ring-0 text-gray-700 placeholder-transparent peer"
                  placeholder=""
                  required
                />
                <label
            ...
            <div class="space-y-2">
              <div class="relative mt-6">
                ...
                <Input
                  ...
                  class="pl-10 pr-10 h-12 bg-transparent border-0 border-b-2 border-gray-700 focus:border-cyan-500 focus:ring-0 text-gray-700 placeholder-transparent peer"
                  placeholder=""
                  required
                />
                <button
            ...
            <div class="text-center pt-4">
              <p class="text-gray-600 text-sm">
                ...
                <button
                  type="button"
                  @click="toggleForm"
                  class="text-cyan-600 font-semibold hover:text-cyan-700"
                >
                  Sign Up
                </button>
              </p>
        ...
        <div v-show="!isLogin" class="w-full max-w-md mx-auto pb-8">
          <form @submit.prevent="submitRegister" class="space-y-4">
            ...
            <div class="space-y-2">
              <div class="relative mt-6">
                <Shield class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 pointer-events-none z-10" />
                <div
                  class="w-full pl-10 pr-8 h-12 bg-transparent border-0 border-b-2 border-gray-700 focus-within:border-cyan-500 focus-within:ring-0 appearance-none text-gray-700 placeholder-transparent peer flex items-center cursor-pointer relative"
              ...
              <div v-if="registerForm.errors.role_id" class="text-red-500 text-xs">
            ...
            <div class="space-y-2">
              <div class="relative mt-6">
                <Building class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 pointer-events-none z-10" />
                <div
                  class="w-full pl-10 pr-8 h-12 bg-transparent border-0 border-b-2 border-gray-700 focus-within:border-cyan-500 focus-within:ring-0 appearance-none text-gray-700 placeholder-transparent peer flex items-center cursor-pointer relative"
              ...
              <div v-if="registerForm.errors.department_ids" class="text-red-500 text-xs">
            ...
            <Button
              type="submit"
              class="w-full h-12 bg-gray-800 hover:bg-gray-700 text-white font-medium rounded-full mt-6"
            ...
            <div class="text-center pt-4">
              <p class="text-gray-600 text-sm">
                Sudah punya akun?
                <button type="button" @click="toggleForm" class="text-cyan-600 font-semibold hover:text-cyan-700">
                  Sign In
                </button>
              </p>
            </div>
    ...
    <!-- DESKTOP LAYOUT -->
    <div class="hidden md:flex h-screen w-full relative">
      <!-- Login Panel Desktop -->
      <div
        ...
        <div class="w-full max-w-md">
          <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-2">
              Sign In to
              <span class="font-normal font-pacifico bg-gradient-to-b from-[#22C1C3] to-[#41499F] text-transparent bg-clip-text">SEFTi.</span>
            </h2>
          </div>
      ...
      <div
        class="w-1/2 flex items-center justify-center p-8 bg-[#DFECF2] relative transition-all duration-700 ease-in-out overflow-y-auto"
        :class="{ 'opacity-100 z-10': !isLogin, 'opacity-0 z-0': isLogin }"
      >
          ...
          <form @submit.prevent="submitRegister" class="space-y-4">
            ...
            <div class="space-y-2">
              <div class="relative mt-6" ref="departmentDropdownRef">
                ...
                <div v-if="registerForm.errors.department_ids" class="text-red-500 text-xs mt-1">
                  {{ registerForm.errors.department_ids }}
                </div>
              </div>
            </div>
        ...
        <div class="flex items-center justify-center h-full">
          <div class="text-center z-10 p-8">
            ...
            <p v-if="isLogin" class="text-lg text-gray-300 mb-8 max-w-md mx-auto">
              ...
              <span class="bg-gradient-to-b from-[#22C1C3] to-[#41499F] text-transparent bg-clip-text">SEFTi.</span>
            </p>
