...
function getActionDescription(action: string) {
  switch (action.toLowerCase()) {
    case "created":
    case "create":
      return "Membuat data Pengeluaran";
    case "updated":
    case "update":
      return "Mengubah data Pengeluaran";
    case "deleted":
    case "delete":
      return "Menghapus data Pengeluaran";
    case "out":
      return "Mengeluarkan data Pengeluaran";
    case "received":
      return "Menerima data Pengeluaran";
    case "returned":
      return "Mengembalikan data Pengeluaran";
    default:
      return action;
  }
}
...
function applyFilters() {
  ...
  router.get(`/pengeluarans/${props.pengeluaran?.id}/logs`, params, {
    preserveState: true,
    preserveScroll: true,
  });
}
  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="px-4 pt-4 pb-6">
      <LogScaffold
        ...
        headerTitle="Pengeluaran Activity Details"
        infoTitle="Pengeluaran Activities"
        :infoSubtitle="`Riwayat aktivitas untuk Pengeluaran ${ pengeluaran?.nama || '' }`"
        :icon="User"
      >
        ...
        <div class="space-y-0">
            ...
            <div class="flex items-center">
              <div class="text-left">
                <h3 class="text-lg font-semibold text-gray-900 capitalize mb-1">
                  {{ getActionDescription(log.action) }} {{ pengeluaran?.nama }}
                </h3>
          ...
          >
            ...
            <p class="text-gray-500">
              There are no activities recorded for this pengeluaran.
            </p>
          </div>
        </div>
