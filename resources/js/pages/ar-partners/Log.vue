...
function getActionDescription(action: string) {
  switch (action.toLowerCase()) {
    case "created":
    case "create":
      return "Membuat data Customer";
    case "updated":
    case "update":
      return "Mengubah data Customer";
    case "deleted":
    case "delete":
      return "Menghapus data Customer";
    case "out":
      return "Mengeluarkan data Customer";
    case "received":
      return "Menerima data Customer";
    case "returned":
      return "Mengembalikan data Customer";
    default:
      return action;
  }
}
...
function applyFilters() {
  ...
  router.get(`/ar-partners/${props.arPartner?.id}/logs`, params, {
    preserveState: true,
    preserveScroll: true,
  });
}
  ...
  <div class="bg-[#DFECF2] min-h-screen">
    <div class="px-4 pt-4 pb-6">
      <LogScaffold
        ...
        headerTitle="Customer Activity Details"
        infoTitle="Customer Activities"
        :infoSubtitle="`Riwayat aktivitas untuk Customer ${ arPartner?.nama_ap || '' }`"
        :icon="User"
      >
            ...
            <div class="flex items-center">
              <div class="text-left">
                <h3 class="text-lg font-semibold text-gray-900 capitalize mb-1">
                  {{ getActionDescription(log.action) }} {{ arPartner?.nama_ap }}
                </h3>
