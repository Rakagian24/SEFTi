  ...
  <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    ...
    <div class="mb-4">
      <div class="flex justify-between text-sm text-gray-600 mb-2">
        ...
        <span>
          {{ terminData.jumlah_termin_dibuat || 0 }} /
          {{ terminData.jumlah_termin || 0 }}
        </span>
      </div>
    ...
    <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4 items-center">
      <div class="flex items-center">
        <div
          ...
          :class="{
            'bg-green-500': terminData.status_termin === 'completed',
            'bg-yellow-500': terminData.status_termin === 'in_progress',
            'bg-gray-400': terminData.status_termin === 'not_started',
          }"
        ></div>
        <span
          :class="{
            'text-green-600 font-semibold': terminData.status_termin === 'completed',
            'text-yellow-600 font-semibold': terminData.status_termin === 'in_progress',
            'text-gray-600 font-semibold': terminData.status_termin === 'not_started',
          }"
        >
          {{
