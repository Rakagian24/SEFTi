...
<template>
  ...
  <EmptyState
    ...
    description="There are no suppliers to display. Start by adding your first supplier."
    icon="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"
    action-text="Add Supplier"
    :show-action="true"
    @action="handleAdd"
  />
          ...
          >
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-[#101010] relative">
              <div class="flex items-center">
                ...
                <!-- <button
                  v-if="hasAddress(row.alamat)"
                  @click.stop="openAlamatDialog(row.alamat)"
                  class="ml-1 text-gray-400 hover:text-gray-700 focus:outline-none flex-shrink-0"
                  title="Lihat alamat lengkap (dialog)"
                >
