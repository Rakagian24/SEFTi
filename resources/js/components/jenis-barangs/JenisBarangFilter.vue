...
const emit = defineEmits(['update:search', 'update:status', 'update:entriesPerPage', 'reset']);
...
const showFilters = ref(localStorage.getItem('jenisBarangShowFilters') === 'true');
function toggleFilters() {
  showFilters.value = !showFilters.value;
  localStorage.setItem('jenisBarangShowFilters', showFilters.value ? 'true' : 'false');
}
</script>
