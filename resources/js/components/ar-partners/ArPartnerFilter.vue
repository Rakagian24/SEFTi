...
function updateJenisAr(value: string) {
  emit("update:jenisAr", value);
}
...
const showFilters = ref(localStorage.getItem('arPartnerShowFilters') === 'true');
function toggleFilters() {
  showFilters.value = !showFilters.value;
  localStorage.setItem('arPartnerShowFilters', showFilters.value ? 'true' : 'false');
}
</script>
