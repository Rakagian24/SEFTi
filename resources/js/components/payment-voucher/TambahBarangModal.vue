    ...
    >
      ...
      <div class="px-6 py-6">
        ...
        <div class="space-y-4">
          ...
          <div class="floating-input">
            <select v-model="form.satuan" id="tb_satuan" class="floating-input-field">
              <option value="">Pilih Satuan</option>
              <option value="Pcs">Pcs</option>
              <option value="Kg">Kg</option>
              <option value="Lembar">Lembar</option>
            </select>
            <label for="tb_satuan" class="floating-label"
          ...
          <div class="flex gap-3 pt-4">
            ...
            <button
              type="button"
              @click="addItem"
              class="flex-1 bg-[#5856D6] hover:bg-[#4b49c4] text-white font-medium py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
            >
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path
                  stroke-linecap="round"
...
.floating-input-field:is(select) option {
  padding: 0.5rem;
}

/* When select has value, move label up */
.floating-input-field:is(select):not([value=""]) ~ .floating-label,
.floating-input-field:is(select):valid ~ .floating-label {
  top: -0.5rem;
  font-size: 0.75rem;
  line-height: 1rem;
  color: #333333;
