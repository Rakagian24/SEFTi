...
function toggleFilters() {
  ...
  localStorage.setItem('bisnisPartnerShowFilters', showFilters.value ? 'true' : 'false');
}
</script>
          ...
          <Transition name="filter-expand">
            ...
            >
              ...
              <div class="flex-shrink-0">
                <CustomSelectFilter
                  :model-value="jenisBp ?? ''"
                  @update:modelValue="updateJenisBp"
                  :options="[
                    { label: 'Jenis Bisnis Partner', value: '' },
                    { label: 'Customer', value: 'Customer' },
                    { label: 'Karyawan', value: 'Karyawan' },
                    { label: 'Cabang', value: 'Cabang' },
                  ]"
                  placeholder="Jenis Bisnis Partner"
