...
const departmentOptionsMapped = computed(() => {
  const base = [{ label: 'Pilih Departemen', value: '' }];
...
function applyFilter() {
  ...
  payload.tanggal_start = localFilters.value.tanggal_start || '';
  payload.tanggal_end = localFilters.value.tanggal_end || '';
  payload.department_id = localFilters.value.department_id || '';
  emit('filter', payload);
